...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'fine-blog' ); ?></a>
			...
			<div class="slick-blog-top-header">
				<?php if ( ! empty( get_header_image() ) ) : ?>
					<div class="header-bg-image">
						<img src="<?php echo esc_url( get_header_image() ); ?>" alt="<?php esc_attr_e( 'Header Image', 'fine-blog' ); ?>">
					</div>	
				<?php endif; ?>
