...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Fine_Blog_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'fine-blog-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="fine_blog_upsell_sections accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
