<?php
if ( ! class_exists( 'Slick_Blog_Trending_Posts_Widget' ) ) {
	/**
	 * Adds Slick_Blog_Trending_Posts_Widget Widget.
	 */
	class Slick_Blog_Trending_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$slick_blog_grid_widget_ops = array(
				...
				'description' => __( 'Retrive Trending Posts Widgets', 'slick-blog' ),
			);
			parent::__construct(
				'slick_blog_trending_posts_widget',
				__( 'Ascendoor Trending Posts Widget', 'slick-blog' ),
