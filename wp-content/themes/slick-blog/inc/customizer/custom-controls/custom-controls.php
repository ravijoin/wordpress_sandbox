...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Slick_Blog_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class Slick_Blog_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type.
		 */
		public $type = 'hr';
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Slick_Blog_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'slick-blog-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="slick_blog_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
